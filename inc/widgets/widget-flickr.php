...
class Bean_Flickr_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'bean_flickr', // Base ID
			__( 'Flickr Photos', 'wonder' ), // Name
			array( 'description' => __( 'Add a Flickr feed widget.', 'wonder' ) ) // Args
		);
	}
	...
	function widget( $args, $instance ) {
		...
		<div class="flickr-image-wrapper">
			<script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count=9&amp;display=<?php echo esc_js( $display ); ?>&amp;size=s&amp;layout=x&amp;source=<?php echo esc_js( $type ); ?>&amp;<?php echo esc_js( $type ); ?>=<?php echo esc_js( $flickrID ); ?>"></script>
		</div>
	...
	function form( $instance ) {
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title / Intro:', 'wonder' ); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'flickrID' ) ); ?>"><?php esc_html_e( 'Flickr ID:', 'wonder' ); ?> (<a target="_blank" href="http://idgettr.com/">idGettr</a>)</label>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>"><?php esc_html_e( 'Type:', 'wonder' ); ?></label>
...
>Group</option>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'display' ) ); ?>"><?php esc_html_e( 'Display:', 'wonder' ); ?></label>
