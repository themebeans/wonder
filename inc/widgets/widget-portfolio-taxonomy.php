...
class Bean_Portfolio_Taxonomy_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Portfolio Taxonomy', 'wonder' ), // Name
			array( 'description' => __( 'A cloud of portfolio tags or categories.', 'wonder' ) ) // Args
		);
	}
	...
	function form( $instance ) {
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'tax' ); ?>"><?php esc_html_e( 'Taxonomy:', 'wonder' ); ?></label>
